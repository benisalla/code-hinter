...
def get_exercises_by_prof_id(prof_id):
    """
    Return all exercises created by the professor.
    """
...
def get_students_by_prof_id(prof_id):
    """
    Return all students associated with this professor.
    Uses the stud_prof associations and then retrieves student details.
    """
